...
- **Digital Skill Passport**: Public professional skill identity with 94/100 Trust Score gauges, verification sources, earned badges, and session activity timeline.
- **SkillX Credits Wallet**: Balance dashboard, transaction log (+Earned / -Spent), and **Indirect Swap Flow (A → B → C → D → A)** interactive graph.
- **Swap Requests & Lifecycle**: Propose direct swaps with preferred dates, time slots, and modes (SKILLX Live Room, Google Meet, Campus Library).
- **Real-Time Style Messaging**: Integrated chat room with session context top bar and video call link generator.
...
```bash
# 1. Clone repository
git clone https://github.com/shivanistalin2006-dot/ThiranInai-SkillX.git
cd ThiranInai-SkillX
...
Built for **THIRANINAI** · SKILLX 2026  
